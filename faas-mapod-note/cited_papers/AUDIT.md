...
| `cybenko1989` | Yes | Yes | None | Metadata-verified, no open-access PDF |
| `leechoi2021` | Yes | Yes | None | Metadata-verified, no open-access PDF |
| `mitzenmacher2001` | Yes | Yes | None | Downloaded (reused) — `mitzenmacher2001.pdf`, 242 KB |
| `willebeek1993` | Yes | Yes | None | Metadata-verified, no open-access PDF |
...
- New legal open-access downloads: 0 (no legal free copy found for `cybenko1989`, `willebeek1993`, `leechoi2021` after legitimate attempts; no paywall was bypassed).
- Metadata-verified, no open-access PDF: `cybenko1989`, `willebeek1993`, `leechoi2021` — 3 works.

**Tally: 2 reused + 0 new + 3 metadata-only.**
